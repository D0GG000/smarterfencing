...
BASE_IMAGE="${BASE_IMAGE:-aliceds/fencing-base:latest}"
WEIGHTS_IMAGE="${WEIGHTS_IMAGE:-aliceds/fencing-weights:latest}"
APP_IMAGE="${APP_IMAGE:-aliceds/fencing-mmpose:latest}"
PUSH="${PUSH:-1}"
