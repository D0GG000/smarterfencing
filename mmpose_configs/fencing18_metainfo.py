dataset_info = dict(
    dataset_name="fencing18",
    paper_info=dict(
        author="custom",
        title="Fencing with bellguard keypoint",
        container="internal",
        year="2026",
        homepage="",
    ),
    keypoint_info={
        ...
        8: dict(
            name="right_elbow", id=8, color=[255, 128, 0], type="upper", swap="left_elbow"
        ),
        9: dict(
        ...
        14: dict(
            name="right_knee", id=14, color=[255, 128, 0], type="lower", swap="left_knee"
        ),
        15: dict(
            name="left_ankle",
            id=15,
        ...
        17: dict(name="bellguard", id=17, color=[255, 0, 255], type="upper", swap=""),
    },
    skeleton_info={
